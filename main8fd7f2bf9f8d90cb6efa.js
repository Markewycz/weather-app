...
var App = /*#__PURE__*/function () {
      ...
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(city) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 5:
              dataForecast = _context.sent;
              return _context.abrupt("return", dataForecast);
            case 7:
            case "end":
  ...
  _createClass(App, [{
    key: "processData",
    value: function processData(city) {
      var _this = this;
      return this.fetchData(city).then(function (data) {
        var forecast = [];
        var city = data.location.name;
        var country = data.location.country;
        var condition = data.current.condition.text;
        var conditionIcon = data.current.condition.icon;
        var degree = data.current.temp_c.toString();
        var color = _this.weatherColor(degree);
        data.forecast.forecastday.forEach(function (days) {
          var _days$date$split = days.date.split('-'),
            _days$date$split2 = _slicedToArray(_days$date$split, 3),
            _ = _days$date$split2[0],
            month = _days$date$split2[1],
            dayz = _days$date$split2[2];
          var date = "".concat(dayz, ".").concat(month);
          var maxC = days.day.maxtemp_c;
          var minC = days.day.mintemp_c;
          var conditionIcon = days.day.condition.icon;
          var color = _this.weatherColor(days.day.avgtemp_c);
          var day = {
            date: date,
            maxC: maxC,
            minC: minC,
    ...
    key: "weatherColor",
    value: function weatherColor(temp) {
      ...
      for (var _i2 = 0, _temperatureRanges = temperatureRanges; _i2 < _temperatureRanges.length; _i2++) {
        var range = _temperatureRanges[_i2];
        if (temp >= range.min) {
          return range.prop;
        }
      }
...
var UI = /*#__PURE__*/function () {
  function UI() {
    ...
    this.app = new _App__WEBPACK_IMPORTED_MODULE_0__["default"]();
  }
  _createClass(UI, [{
    key: "loadHomepage",
    ...
    key: "searchCity",
    value: function () {
      var _searchCity = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(city) {
        var _this = this;
        var input, processedData;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              !city ? input = document.getElementById('cityInput').value : input = city;
              if (input) {
                _context.next = 5;
                break;
              }
            ...
            case 5:
              ...
              this.clearForecast();
              _context.next = 9;
              return this.app.processData(input);
            case 9:
              processedData = _context.sent;
              this.displayCurrentDay(processedData.city, processedData.country, processedData.condition, processedData.conditionIcon, processedData.degree, processedData.color);
              processedData.forecast.forEach(function (day) {
                _this.displayForecast(day.date, day.maxC, day.minC, day.conditionIcon, day.color);
              });
              _context.next = 17;
              break;
            case 14:
    ...
    key: "displayCurrentDay",
    value: function displayCurrentDay(city, country, condition, icon, degree, color) {
      var container = document.getElementById('currentDay');
      var html = "\n      <div class=\"flex flex-col justify-center items-center gap-4\">\n        <p class=\"text-4xl sm:text-4xl md:text-5xl lg:text-5xl font-normal\">\n          ".concat(city, "<span class=\"font-light text-lg sm:text-xl md:text-2xl lg:text-3xl\">, ").concat(country, "</span>\n        </p>\n        <p class=\"text-base md:text-lg lg:text-xl\">").concat(condition, "</p>\n      </div>\n      <img src=\"").concat(icon, "\" class=\"w-36 md:w-38\"></img>\n      <div class=\"font-light text-3xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl\">").concat(degree, "<span class\"font-thin\">&#8451;</span></div>\n    ");
      container.classList.add(color);
      container.innerHTML = html;
    }
  }, {
    key: "displayForecast",
    value: function displayForecast(date, maxC, minC, icon, color) {
      var html = "\n      <div class=\"flex justify-between gap-5 lg:flex-col lg:justify-between items-center ".concat(color, " p-5 border-b-2 border-white last:border-b-0 lg:border-b-0 lg:border-r-2 last:border-r-0\">\n        <div class=\"font-normal lg:text-2xl xl:text-3xl\">").concat(date, "</div>\n        <img src=\"").concat(icon, "\" class=\"w-14 md:w-24\"></img>\n        <p class=\"font-normal whitespace-nowrap lg:text-2xl  xl:text-3xl\">\n          ").concat(maxC, "<span class\"font-thin\">&#8451;</span><span class=\"font-light text-base lg:text-lg xl:text-xl\"> / ").concat(minC, "<span class\"font-thin\">&#8451;</span></span>\n        </p>\n      </div>\n    ");
    ...
    value: function initLocation() {
      ...
      var location = navigator.geolocation.getCurrentPosition(function (position) {
        _this2.searchCity("".concat(position.coords.latitude, ",").concat(position.coords.longitude));
      });
    }
  }, {
    key: "clearForecast",
    value: function clearForecast() {
      document.getElementById('weeklyForecast').innerHTML = '';
    }
  }, {
    key: "showErrorMsg",
    value: function showErrorMsg(state) {
      var alertMsg = document.getElementById('alertMsg');
      if (state = 'name') alertMsg.textContent = 'Incorrect city name, please type again.';
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _src_input_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../src/input.css */ "./src/input.css");
